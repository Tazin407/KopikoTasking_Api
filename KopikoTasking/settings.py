"""
Django settings for KopikoTasking project.
...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://kopikotasking-api.onrender.com','https://*.127.0.0.1']
...
WSGI_APPLICATION = 'KopikoTasking.wsgi.application'
